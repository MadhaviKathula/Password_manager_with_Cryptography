...
import main_def_fun  # Define all the functions used here  
...
def login():
   if (username_entry.get() == "" or password_entry.get() == ""):
       ...
       try:
           ...
           if main_def_fun.searchUser(key, username, password) == True:
               root.destroy()
...
def signup():
   if (username_entry.get() == "" or password_entry.get() == ""):
       ...
       try:
           main_def_fun.tableCreate()  # Searches to see if database has all ready been created
       ...
       try:
           ...
           main_def_fun.signup(encrypted_username,
